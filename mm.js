...
window.onload=function(){
  ...
  document.getElementById("WHITE").selected = "true";
}
...
class Cell {
  ...
  show(size, rows, columns) {
    ...
    //error prone color undefined 
    let wall_col=document.getElementById("dd1");
    wall_col.addEventListener('change',change_wall);
    
    ctx.strokeStyle = (col === undefined) ? "white" : col ; 
    ctx.fillStyle = "black";
    ctx.lineWidth = 2;
...
// let test;
// let check_diff=document.getElementById("dd2")
// let value=check_diff.options[check_diff.selectedIndex].value;
// console.log(value);
// if (value==="easy") {
//   n=10;
// }
...
let n;
let value=document.getElementById("dd2");
function logValue(){
...
value.addEventListener('change', logValue);
function create(){
  maze_count++;
  if (maze_count>3) {
    document.location.reload();
  }
  newMaze = new Maze(500,n, n);
  newMaze.setup();
  newMaze.draw();
}
